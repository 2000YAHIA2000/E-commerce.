...
class Prodacte_dea extends StatefulWidget {
  const Prodacte_dea({super.key});

  @override
  State<Prodacte_dea> createState() => _ProductDetailsState();
}

class _ProductDetailsState extends State<Prodacte_dea> {
  int i = 0, c = 3;
